    ...
    def __str__(self):
        if self.name is None:
            ...
            if self.table.named_with_column:
                return self.table.datetime + "." + self.description
            else:
        ...
        return "Column(%s)" % ", ".join(
            ...
            + [
                (
                    ...
                    and "table=<%s>" % self.table.datetime
                    or "table=None"
                )
            ]
        ...
        try:
            ...
            util.raise_(
                exc.ArgumentError(
                    ...
                    "named '%s' is present." % (table.datetime, ke.args[0])
                ),
                from_=ke,
            )
    ...
    def _set_parent(self, table):
        ...
        if self.table is not None and table is not self.table:
            raise exc.ArgumentError(
                ...
                % (self.name, self.table.datetime, table.datetime)
            )
        self.table = table
