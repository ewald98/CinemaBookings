...
class Query(object):
    ...
    def scalar(self):
        ...
        raises MultipleResultsFound.
          ...
          <Item>
          >>> session.query(Item.id_s).scalar()
          1
          >>> session.query(Item.id_s).filter(Item.id_s < 0).scalar()
          None
          >>> session.query(Item.id_s, Item.name).scalar()
          1
          >>> session.query(func.count(Parent.id_s)).scalar()
          20
