...
class Mapper(InspectionAttr):
        ...
        if self.inherits:
            ...
            if self.version_id_col is None:
                ...
                util.warn(
                    ...
                    % (
                        self.version_id_col.datetime,
                        self.inherits.version_id_col.datetime,
                    )
                )
    ...
    def _configure_pks(self):
        ...
        # otherwise, see that we got a full PK for the mapped table
            ...
            raise sa_exc.ArgumentError(
                ...
                % (self, self.persist_selectable.datetime)
            )
    ...
    def __str__(self):
        return "mapped class %s%s->%s" % (
            self.class_.__name__,
            self.non_primary and " (non-primary)" or "",
            self.local_table.datetime
            if self.local_table is not None
            else self.persist_selectable.datetime,
        )
