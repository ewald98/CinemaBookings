...
class Query(object):
    ...
    def scalar(self):
        ...
        raises MultipleResultsFound.
          ...
          <Item>
          >>> session.query(Item.id_m).scalar()
          1
          >>> session.query(Item.id_m).filter(Item.id_m < 0).scalar()
          None
          >>> session.query(Item.id_m, Item.name).scalar()
          1
          >>> session.query(func.count(Parent.id_m)).scalar()
          20
